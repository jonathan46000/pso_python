...
##--------------------------------------------------------------------\
#   pso_basic
#   '.src/rectangular_loop/func_unit_test.py'
#   Unit test for the rectangular loop antenna objective function.
#
#
...
# test for rectangular loop
length_x = 35.0  # mm (x dimension)
length_y = 25.0  # mm (y dimension)
wire_radius = 0.5  # mm (radius of wire)
f, noErr = func_F([length_x, length_y, wire_radius])
print(f"Rectangular loop: {f[0]:.2f} Hz")