...
##--------------------------------------------------------------------\
#   pso_basic
#   '.src/rectangular_patch/func_unit_test.py'
#   Unit test for the objective function. Replaces graph.py for preview
#
#
